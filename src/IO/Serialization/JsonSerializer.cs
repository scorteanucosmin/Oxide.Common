...
//{
//    public class JsonSerializer<T> : ISerializer<string, T>, ISerializer<byte[], T>, IDeserializer<T, byte[]>, IDeserializer<T, string>
//    {
...
//        byte[] ISerializer<byte[], T>.Serialize(T obj)
//        {
